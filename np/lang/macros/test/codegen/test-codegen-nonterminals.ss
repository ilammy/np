...
(define-test-case (nonterminals:extension-modification "Code generation for extension modification nonterminal forms")
  ...
  (define (assert-mod modified name added-meta-vars removed-meta-vars added-production-definitions removed-production-definitions)
  ...
  (define-test ("Does not change nonterminal order")
    (for mods '((Number #f (a b c) (d) (e f) (g h i)) (Pair #f (j) () () (k)))
      ...
      (assert-mod (first mods) 'Number '(a b c) '(d) '(e f) '(g h i))
